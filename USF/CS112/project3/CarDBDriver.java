...
public class CarDBDriver {
	public static void main(String[] args) {
		...
		Carlist list = builder.buildCarlist(filename);

		//print all cars by calling toString on carlist
		System.out.println("All Cars:");
		System.out.println(list.toString());

		//print cars by calling toStringGreenCars on carlist
